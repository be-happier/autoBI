...
import com.jun.autoBI.model.domain.request.UserLoginRequest;
import com.jun.autoBI.model.domain.request.UserRegisterRequest;
...
import static com.jun.autoBI.contant.UserConstant.ADMIN_ROLE;
...
public class UserController {
    ...
    public BaseResponse<User> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request){
        ...
        return ResultUtils.succesee(user);
    }
    ...
    public BaseResponse<User> getCurrentUser(HttpServletRequest request) {
        ...
        return ResultUtils.succesee(safetyUser);
    }

    @GetMapping("/search")
    public BaseResponse<List<User>> searchUsers(String username, HttpServletRequest request) {
        if(!isAdmin(request)) {
            throw new BusinessException(ErrorCode.NOT_AUTH_ERROR, "缺少管理员权限");
        }
        ...
        return ResultUtils.succesee(list);
    }
